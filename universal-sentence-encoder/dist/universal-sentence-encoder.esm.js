...
import { util, tidy, tensor2d, tensor1d } from '@tensorflow/tfjs-core';
...
function loadVocabulary(pathToVocabulary) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, util.fetch(pathToVocabulary)];
                case 1:
                    vocabulary = _a.sent();
...
var UniversalSentenceEncoderQnA = /** @class */ (function () {
    ...
    UniversalSentenceEncoderQnA.prototype.loadModel = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, loadGraphModel(BASE_PATH$1, { fromTFHub: true })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, modelUrl
                        ...
                        : loadGraphModel('https://tfhub.dev/tensorflow/tfjs-model/universal-sentence-encoder-lite/1/default/1', { fromTFHub: true })];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        indices = tensor2d(flattenedIndicesArr, [flattenedIndicesArr.length, 2], 'int32');
                        values = tensor1d(util.flatten(encodings), 'int32');
